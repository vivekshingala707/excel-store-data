...
const Products = () => {
    ...
    const array = [{
        name: "Store Your Data",
        des: "Combine PDFs in the order you want with the easiest PDF merger available"
    }, 2, 3, 4, 5, 6, 7, 8, 9]
    return (
        <div className='px-2.5 py-4 flex flex-wrap w-full bg-slate-100'>
            {
                array.map((items) => {
                    return (
                        <>
                            <div className=' p-2 flex flex-col    2xl:w-1/5 xl:w-1/4 lg:w-1/3 md:1/2 w-1/2 rounded'>
                                <div className='bg-white p-6 space-y-2 rounded'>
                                    ...
                                    <h2 className='font-bold'>{items.name ? items.name : "Merge Pdf"}</h2>
                                    <p className='text-sm'> Combine PDFs in the order you want with the easiest PDF merger available.</p>
                                </div>
                            </div>
                        </>
                    )
